...
public class WorkoutController {
    ...
    public @ResponseBody ResponseEntity<Workout> updateUser(@Param("id") Integer id, @RequestBody Workout updateWorkout) {

        workoutService.updateWorkout(id, updateWorkout);
        return new ResponseEntity<>(HttpStatus.OK);
    }
}
